    ...
    return (
      <div className='bar'>
        <div className='card text-center' id="synonym">
          <div className='hide card' onClick={() => {
            showHide(1)
          }}><span id="hide-text">&lt;</span></div>
          <h3>Find synonym</h3>
          <input type='text' className='form-control' id='synonym-input'/>
          <button className='btn btn-outline-dark' onClick={() => {
            getSynonym(document.getElementById("synonym-input").value)
          }}>Submit
          </button>
        ...
        <div className='card text-center' id="translate">
          <div className='hide card' onClick={() => {
            showHide(2)
          }}><span id="hide-text-2">&lt;</span></div>
          <h3>Translate</h3>
          <input type='text' className='form-control' id='translate-input'/>
          <div className="row" style={{marginLeft: "5px"}}>
            <button className='btn btn-outline-dark col-md-5' onClick={() => {
              getTranslate(document.getElementById("translate-input").value, 1)
            }}>PL > EN
            </button>
            <button className='btn btn-outline-dark col-md-5' onClick={() => {
              getTranslate(document.getElementById("translate-input").value, 2)
            }}>EN > PL
            </button>
          </div>
